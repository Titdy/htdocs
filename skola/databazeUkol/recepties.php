...
<div class="login">
    <form method="POST">
      ...
      <label for="recept">Kód E-receptu</label><br>
      <input type="text" id="recept" name="recept" minlength="12" maxlength="12" required><br>
  ...
  if(isset($_POST['odeslat'])){
    ...
    $sql = " ";
    $sql = "INSERT INTO recipes (recipe_name, surname, recipe_adress, recipe_code) VALUES ('$name', '$surname', '$adress', '$recipe')";
